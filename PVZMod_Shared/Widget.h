#pragma once
#ifndef _PVZMOD_WIDGET_H_
#define _PVZMOD_WIDGET_H_
...
namespace PVZMod
{
	...
	public:
		...
		static bool				mWriteColoredString;  // controls whether ^color^ works in calls to WriteString, 在游戏中被内联为固定值1，需要注意
