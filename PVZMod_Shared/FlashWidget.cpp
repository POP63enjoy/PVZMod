...
static std::string GetPathFrom(const std::string& theRelPath, const std::string& theDir)
{
...
static std::string GetFullPath(const std::string& theRelPath)
{
