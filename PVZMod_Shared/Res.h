...
namespace PVZMod
{
	...
	extern bool(*ExtractGameResourcesByName)(ResourceManager* theManager, const char* theName);
	bool ExtractDllResourcesByName(ResourceManager* theManager, const char* theName);
	bool ExtractAllResourcesByName(ResourceManager* theManager, const char* theName);
	extern std::list<std::pair<String, bool(*)(ResourceManager*, const char*)>> gResFileList;
