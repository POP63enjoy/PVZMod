...
SexyString PVZMod::DIALOG_YES_STRING = _S("YES");
SexyString PVZMod::DIALOG_NO_STRING = _S("NO");
SexyString PVZMod::DIALOG_OK_STRING = _S("OK");
SexyString PVZMod::DIALOG_CANCEL_STRING = _S("CANCEL");
